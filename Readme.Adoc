...
* * =*** * ** ** ** * * [Install on Windows with WSL](https://github.com/koreader/koreader/wiki/Install-on-Windows-with-WSL)=
* * =*** * ** ** ** * * [Install using Linux container (Docker, Podman)](https://github.com/koreader/koreader/wiki/Install-using-Linux-container-(Docker,-Podman))=
...
* * =*** * ** ** ** * * [ZIP file support](https://github.com/koreader/koreader/wiki/ZIP)=
...
* * =*** * ** ** ** * * [Auto standby](https://github.com/koreader/koreader/wiki/Auto-Standby)=
...
* * =*** * ** ** ** * * [Highlight exporter](https://github.com/koreader/koreader/wiki/Highlight-export)=
...
* * =*** * ** ** ** * * [Vocabulary builder](https://github.com/koreader/koreader/wiki/Vocabulary-builder)=
* * =*** * ** ** ** * * [Wallabag](https://github.com/koreader/koreader/wiki/Wallabag)=

* * =*** * ** ** ** *  [User patches](https://github.com/koreader/koreader/wiki/User-patches)=
* * =*** * ** ** ** * * [[Overview|https://github.com/koreader/koreader/wiki/User-patches#overview]]=
* * =*** * ** ** ** * * [[Installation|https://github.com/koreader/koreader/wiki/User-patches#installation]]=
* * =*** * ** ** ** * * [[Available patches|https://github.com/koreader/koreader/wiki/User-patches#available_patches]]=
...
* * =*** * ** ** ** *   * [KOReader 手势操作](https://github.com/koreader/koreader/wiki/KOReader手势操作)=
* * =*** * ** ** ** *   * [KOReader 用户手册](https://github.com/koreader/koreader/wiki/KOReader用户手册)=
* * =*** * ** ** ** *   * [在 Kindle 上安装和运行 KOReader](https://github.com/koreader/koreader/wiki/在Kindle上安装和运行KOReader)=
* * =*** * ** ** ** *   * [在 Kobo 上安装和运行 KOReader](https://github.com/koreader/koreader/wiki/如何在Kobo上安装KOReader)=
